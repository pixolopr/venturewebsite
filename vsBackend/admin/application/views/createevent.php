    ...
    <div class="container">
        <div class="create_area z-depth-3">
            <div class="row nomarg">
                <h3 class="col l12"><?php if($inputtype == 'insert'){ echo "CREATE EVENT"; }else{ echo "EDIT"; }; ?></h3>
            </div>
...
<div class="row nomarg">
                <div class="col l12">
                    ...
                    ?>
                    <p>
                      <input type="checkbox" id="<?php echo $tag->id; ?>" checked="checked" />
              ...
              $('#modal1').openModal();
               <?php
                ...
                <?php
                    foreach($tags as $tag){
                        ?>
                if($('#<?php echo $tag->id; ?>').prop('checked') == true){
                    tagarray.push(<?php echo $tag->id; ?>);
                };
                <?php
                    };
                ?>
                console.log(tagarray);
                for(var q=0; q<tagarray.length; q++)
{
    $('#createform').append('<input type="hidden" name="result[]" value="'+tagarray[q]+'" />');
};
